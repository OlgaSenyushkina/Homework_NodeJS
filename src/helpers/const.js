...
export const DB_URL = 'postgres://wpcpjlva:xarRr-5vqBQJkzZ5wQNh6l1U9gQzmwUS@balarama.db.elephantsql.com:5432/wpcpjlva';


export const CREATE_TABLE = 'CREATE TABLE IF NOT EXISTS "users" ("id" UUID NOT NULL , "login" VARCHAR(255) NOT NULL, "password" VARCHAR(255) NOT NULL, "age" NUMBER NOT NULL, "isDeleted" BOOLEAN NOT NULL, PRIMARY KEY ("id"));'

export const INIT_DATA = `INSERT INTO "users" ("id","login","password","age","isDeleted") VALUES 
